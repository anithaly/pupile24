<div class="actions">
  <h3>Pupile</h3>
  <ul>
    <li><?php echo $this->Html->link(__('Moi pupile', true), array('controller' => 'pets', 'action' => 'mypets')); ?></li>
  </ul>
</div>
...
<?php echo $this->Form->create('Pet');?>
	...
	<?php
		...
		echo $this->Form->input('species_id', array('empty' => '-- wybierz gatunek --'));
	?>
	<div id="pet-race"><?php echo $this->Form->input('races_id', array('empty' => '-- wybierz gatunek --'));?></div>
	</fieldset>
