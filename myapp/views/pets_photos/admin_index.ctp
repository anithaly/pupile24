<div class="petsPhotos index">
	...
	<?php
	$i = 0;
	foreach ($petsPhotos as $petsPhoto):
		$class = null;
		if ($i++ % 2 == 0) {
			$class = ' class="altrow"';
		}
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $petsPhoto['PetsPhoto']['id']; ?>&nbsp;</td>
		<td><?php echo $petsPhoto['PetsPhoto']['name']; ?>&nbsp;</td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $petsPhoto['PetsPhoto']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $petsPhoto['PetsPhoto']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $petsPhoto['PetsPhoto']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $petsPhoto['PetsPhoto']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
